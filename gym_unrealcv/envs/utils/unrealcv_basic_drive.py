...
class UnrealCv(object):
    ...
    def set_pose(self, cam_id, pose):  # pose = [x, y, z, roll, yaw, pitch]
        ...
        cmd = 'vset /object/CarAgent/location {x} {y} {z}'
        self.client.request(cmd.format(x=pose[0], y=pose[1], z=-10))
        cmd = 'vset /object/CarAgent/rotation {pitch} {yaw} {roll}'
        self.client.request(cmd.format(roll=pose[3], yaw=pose[4], pitch=pose[5]))
    ...
    def set_location(self,cam_id, loc):  # loc=[x,y,z]
        ...
        cmd = 'vset /object/CarAgent/location {x} {y} {z}'
        self.client.request(cmd.format(x=loc[0], y=loc[1], z=loc[2]))
    ...
    def set_rotation(self,cam_id, rot):  # rot = [roll, yaw, pitch]
        ...
        cmd = 'vset /object/CarAgent/rotation {pitch} {yaw} {roll}'
        self.client.request(cmd.format(roll=rot[0], yaw=rot[1], pitch=rot[2]))
